...
const StatCard = ({
  ...
  return (
    <div className="flex flex-col items-center px-6">
      ...
      <span className="text-[10px] uppercase tracking-[0.25em] text-gray-500 mt-2 font-mono">
        {label}
      </span>
    </div>
  );
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      {dots.map((d) => (
        <div
          key={d.id}
          className="absolute rounded-full bg-white/[.08]"
          style={{
            left: `${d.x}%`,
            top: `${d.y}%`,
            width: d.size,
            height: d.size,
            animation: `particle-drift ${d.dur}s linear infinite`,
...
const MONITORED_ESTATES = [
  {
    name: 'Kruger National Estate',
    country: 'South Africa',
    flag: '🇿🇦',
    area: '19,485 km²',
    species: 'Elephants, Rhinos',
    rangers: 147,
    accent: '#DC2626',
  },
  {
  ...
  },
  {
    ...
    flag: '🇹🇿',
    area: '14,750 km²',
    species: 'Wildebeest, Lions',
    rangers: 156,
    accent: '#10B981',
  },
  {
    name: 'Hwange National Estate',
    country: 'Zimbabwe',
    flag: '🇿🇼',
    area: '14,651 km²',
    species: 'Elephants',
...
const METHODOLOGY = [
  {
    step: '01',
    title: 'INSTALLATION',
    desc: 'Acoustic sensors, camera traps, and motion detectors deployed across the protected zone.',
    icon: Wifi,
  },
  {
    step: '02',
    title: 'DETECTION',
    desc: 'AI processes gunshots, chainsaw signatures, and anomalous movement in real-time.',
    icon: Radar,
  },
  {
    step: '03',
    title: 'INTERPRETATION',
    desc: 'Contextual threat analysis distinguishes poaching activity from natural events.',
    icon: Eye,
  },
  {
    step: '04',
    title: 'THREAT SIGNALING',
    desc: 'Encrypted alerts with GPS coordinates dispatched to ranger units within milliseconds.',
    icon: Zap,
  },
];
  ...
  return (
    <div className="min-h-screen bg-[#050A14] text-white selection:bg-vanguard-species/30 selection:text-white overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 overflow-hidden">
        ...
        >
          ...
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="text-[10px] font-mono tracking-[0.4em] text-vanguard-species uppercase">
              Wildlife Protection Reimagined
            </span>
            <div className="w-8 h-px bg-vanguard-species" />
          </div>
      ...
      <section ref={crisisSection.ref} className="relative py-32 px-6">
        <div className="max-w-5xl mx-auto text-center">
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <span className="text-[10px] font-mono tracking-[0.4em] text-vanguard-critical/80 uppercase">
              Conservation Crisis
            </span>
            <div className="w-10 h-px bg-vanguard-critical/50" />
          </div>
          <h2
            className={`text-4xl md:text-5xl font-sans font-bold mb-6 transition-all duration-1000 ${crisisSection.visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
          >
            The Silent War in Our
            <br />
          ...
          <p
            className={`text-gray-400 max-w-xl mx-auto mb-16 leading-relaxed transition-all duration-1000 delay-200 ${crisisSection.visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
          >
            Every year, thousands of endangered animals are killed by sophisticated poaching
            networks. Traditional patrols can't cover the vast, remote territories that need
            protection.
          </p>

          <div
            className={`grid grid-cols-1 md:grid-cols-3 gap-8 transition-all duration-1000 delay-400 ${crisisSection.visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
          >
            {[
              ...
              <div key={i} className="bg-white/[.03] border border-white/[.06] rounded-lg p-8">
                <div className={`text-3xl md:text-4xl font-mono font-bold mb-2 ${s.color}`}>
                  {s.val}
                </div>
      ...
      <section
        ...
        className="relative py-32 px-6 bg-gradient-to-b from-transparent via-purple-900/[.04] to-transparent"
      >
        <GridBg />
        <div className="max-w-6xl mx-auto">
          ...
          <div
            className={`grid grid-cols-1 lg:grid-cols-2 gap-16 items-center transition-all duration-1000 ${aboutSection.visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
          >
            <div>
              ...
              <p className="text-gray-400 leading-relaxed mb-8">
                Vanguard is an autonomous shield that monitors critical habitats at the millisecond
                scale — bridging the gap between passive observation and active tactical
                intervention. Our AI processes acoustic, visual, and thermal data streams in
                real-time to detect, verify, and neutralize threats before damage is done.
              </p>
                ...
                {[
                  {
                    icon: Zap,
                    title: 'Real-Time',
                    desc: 'Sub-second threat detection and response',
                  },
                  {
                    icon: Globe,
                    title: '31 Countries',
                    desc: 'Global coverage across 6 continents',
                  },
            ...
            <div className="relative rounded-xl border border-white/[.08] bg-white/[.02] overflow-hidden aspect-video">
              ...
              <div className="absolute bottom-4 right-4 w-48 space-y-2">
                {['CRITICAL', 'WARNING', 'INFO'].map((lvl, i) => (
                  <div
                    key={i}
                    className="bg-black/60 backdrop-blur border border-white/10 rounded px-3 py-2 flex items-center gap-2"
                  >
                    <div
                      className={`w-1.5 h-1.5 rounded-full ${lvl === 'CRITICAL' ? 'bg-red-500' : lvl === 'WARNING' ? 'bg-yellow-500' : 'bg-emerald-500'}`}
                    />
      ...
      <section ref={methodSection.ref} className="relative py-32 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <h2
            className={`text-4xl md:text-5xl font-sans font-bold mb-16 transition-all duration-1000 ${methodSection.visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
          >
            How{' '}
          ...
          <div
            className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 transition-all duration-1000 delay-300 ${methodSection.visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}
          >
            {METHODOLOGY.map((m, i) => (
              <div
                key={i}
                className="group relative bg-white/[.02] border border-white/[.06] rounded-xl p-6 hover:border-white/[.12] hover:bg-white/[.04] transition-all duration-300"
              >
                <div className="text-[10px] font-mono text-vanguard-species/60 tracking-[0.3em] mb-4">
                  STEP {m.step}
                </div>
      ...
      <section
        ...
        className="relative py-28 px-6 bg-gradient-to-b from-transparent via-emerald-900/[.04] to-transparent border-y border-white/[.04]"
      >
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            <div className="flex items-center justify-center gap-3 mb-6">
              <div className="w-10 h-px bg-vanguard-species/50" />
              <span className="text-[10px] font-mono tracking-[0.4em] text-vanguard-species/80 uppercase">
                Our Impact
              </span>
              <div className="w-10 h-px bg-vanguard-species/50" />
            </div>
      ...
      <section id="estates" ref={estatesSection.ref} className="relative py-32 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <h2
            className={`text-4xl md:text-5xl font-sans font-bold mb-16 transition-all duration-1000 ${estatesSection.visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
          >
          ...
          <div
            className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 transition-all duration-1000 delay-200 ${estatesSection.visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}
          >
            {MONITORED_ESTATES.map((estate, i) => (
              <div
                key={i}
                className="group relative bg-white/[.02] border border-white/[.06] rounded-xl p-6 hover:border-white/[.12] hover:bg-white/[.04] transition-all duration-300 overflow-hidden"
              >
                {/* Accent glow */}
                <div
                  ...
                  style={{ backgroundColor: estate.accent }}
                />
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: `0 0 6px ${estate.accent}`,
                    }}
                  />
                </div>
                ...
                <div className="grid grid-cols-3 gap-3 pt-4 border-t border-white/[.06]">
                  <div>
                    ...
                    <div className="text-xs font-mono" style={{ color: estate.accent }}>
                      {estate.area}
                    </div>
                  </div>
                  <div>
      ...
      >
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2
              className={`text-4xl md:text-5xl font-sans font-bold transition-all duration-1000 ${tiersSection.visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
            >
              Two Tiers.
              <br />
          ...
          <div
            className={`grid grid-cols-1 lg:grid-cols-2 gap-8 transition-all duration-1000 delay-300 ${tiersSection.visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}
          >
            {/* Government Tier */}
            <div className="group relative bg-white/[.02] border border-white/[.06] rounded-2xl p-8 hover:border-emerald-500/20 transition-all duration-500 overflow-hidden">
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <div className="text-[10px] font-mono text-emerald-500/80 tracking-wider">
                    GOVERNMENT LEVEL
                  </div>
                </div>
              </div>
              ...
              <p className="text-sm text-gray-400 leading-relaxed mb-6">
                Scale and security for continental-level protection. Direct uplink to national
                military and law enforcement command centers with sovereign data handling.
              </p>
            ...
            <div className="group relative bg-white/[.02] border border-white/[.06] rounded-2xl p-8 hover:border-purple-500/20 transition-all duration-500 overflow-hidden">
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <div className="text-[10px] font-mono text-purple-500/80 tracking-wider">
              ...
              <p className="text-sm text-gray-400 leading-relaxed mb-6">
                Tailored monitoring for private reserves. Absolute discretion, zero-latency alerts,
                and bespoke security parameters for unique estate boundaries.
              </p>
      ...
      <section id="contact" ref={ctaSection.ref} className="relative py-32 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <div
            className={`transition-all duration-1000 ${ctaSection.visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
          >
            ...
            <div className="inline-block bg-white/[.03] border border-white/[.06] rounded-xl px-8 py-6">
              <div className="text-[10px] font-mono tracking-[0.3em] text-vanguard-species/80 uppercase mb-3">
                Contact Vanguard
              </div>
              <p className="text-xs text-gray-400 mb-3">
                Reach out for partnerships, deployments, or inquiries
              </p>
              <a
                href="mailto:contact@vanguard.ai"
                className="inline-flex items-center gap-2 text-sm text-vanguard-species hover:text-emerald-300 transition-colors"
              >
