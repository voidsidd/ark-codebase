...
export function buildZonesFromKm(
  centerLat: number,
  centerLon: number,
  zonesKm: Record<string, [number, number][]>
...
export const ESTATE_SHAPES = {
  ...
  maasaimara: (lat: number, lon: number) =>
    buildZonesFromKm(lat, lon, {
      Z1: [
        [-25, 15],
        [-15, 20],
        [-5, 0],
        [-20, -10],
      ], // Mara Triangle (West of River)
      Z2: [
        [-15, 20],
        [0, 25],
        [5, 10],
  ...
  kaziranga: (lat: number, lon: number) =>
    buildZonesFromKm(lat, lon, {
      Z1: [
        [-20, 5],
        [-10, 6],
  ...
  nagarhole: (lat: number, lon: number) =>
    buildZonesFromKm(lat, lon, {
      Z1: [
        [-12, 12],
        [0, 15],
