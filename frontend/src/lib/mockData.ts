...
export const MOCK_ALERTS: AlertEvent[] = [
  {
    ...
    timestamp: '11:21:45',
    description:
      'Deploy ranger unit to Zone 4 immediately. Three correlated human presence signals detected within 90 minutes.',
    priority: 'CRITICAL',
    location: [11.965, 76.14],
  },
  {
    id: 'OH-1102',
    type: 'ONE_HEALTH',
    ...
    timestamp: '10:15:00',
    description:
      'Unusual wildlife health pattern detected in Zone 2. Potential zoonotic risk. Recommend veterinary assessment and public health notification.',
    priority: 'HIGH',
    location: [11.995, 76.14],
    isOneHealth: true,
  },
  {
    id: 'CAM-8821',
