...
const SpeciesIntelPage: React.FC = () => {
  ...
  useEffect(() => {
      ...
      nagarhole: [
        {
          ...
          estimatedCount: 130,
          status: 'Endangered',
          notes: 'Core breeding population in Nagarhole.',
          citation: 'WII Census 2023',
        },
        {
          id: 'ng2',
          estateId: id,
          ...
          estimatedCount: 600,
          status: 'Endangered',
          notes: 'Largest elephant population in the region.',
          citation: 'MOEF 2022',
        },
        {
          id: 'ng3',
          ...
          estimatedCount: 95,
          status: 'Vulnerable',
          notes: 'High density in buffer zones.',
          citation: 'WII 2023',
        },
        {
          id: 'ng4',
          ...
          estimatedCount: 80,
          status: 'Endangered',
          notes: 'Active pack territories in western range.',
          citation: 'BNHS',
        },
        {
          id: 'ng5',
          ...
          estimatedCount: 1200,
          status: 'Vulnerable',
          notes: 'Largest ungulate population.',
          citation: 'Forest Survey 2023',
        },
      ],
      kanha: [
        {
          ...
          estimatedCount: 105,
          status: 'Endangered',
          notes: 'Kanha has been a tiger reintroduction success.',
          citation: 'NTCA 2023',
        },
        {
          id: 'kn2',
          ...
          estimatedCount: 650,
          status: 'Vulnerable',
          notes: 'Kanha is last stronghold of this deer.',
          citation: 'WII 2022',
        },
        {
          id: 'kn3',
          ...
          estimatedCount: 50,
          status: 'Vulnerable',
          notes: 'Avoid direct tiger habitat overlap.',
          citation: 'WII 2023',
        },
        {
          id: 'kn4',
          ...
          estimatedCount: 80,
          status: 'Vulnerable',
          notes: 'Termite-rich meadow zones.',
          citation: 'BNHS 2022',
        },
      ],
      kaziranga: [
        {
          ...
          estimatedCount: 2613,
          status: 'Vulnerable',
          notes: 'Largest rhino population globally.',
          citation: 'WWF 2023',
        },
        {
          id: 'kz2',
          ...
          estimatedCount: 121,
          status: 'Endangered',
          notes: 'Highest tiger density in India.',
          citation: 'NTCA 2023',
        },
        {
          id: 'kz3',
    ...
    const entries = knownFauna[shortId] ?? [
      {
        ...
        estimatedCount: 50,
        status: 'Endangered',
        notes: 'Population estimate from census data.',
        citation: 'NTCA 2023',
      },
      {
        id: 'gen2',
    ...
    entries.forEach((entry) => {
      if (entry.scientificName) fetchWikiImage(entry.scientificName);
    });
    ...
    fetch(
      `https://api.inaturalist.org/v1/observations?quality_grade=research&photos=true&taxon_name=Mammalia&place_guess=${encodeURIComponent(searchPlace)}&per_page=15&order=desc&order_by=created_at`
    )
      ...
      .then((data) => {
        ...
        const mapped: Spotting[] = results.map((obs: any) => ({
          ...
          zone: 'iNaturalist',
          timestamp: obs.time_observed_at
            ? new Date(obs.time_observed_at).toLocaleDateString()
            : obs.observed_on || 'Unknown',
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-vanguard-border bg-black/40">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <span className="ml-2 text-[9px] font-mono text-green-500/70">
                    iNaturalist LIVE
                  </span>
                </div>
              </div>
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar divide-y divide-vanguard-border/60">
              {spottings.length === 0 && !loadingSpottings && (
                <div className="p-4 text-[11px] font-mono text-gray-500">
                  No spottings in the last 24 hours for this estate. Vanguard will surface new
                  ...
                  <div key={spot.id} className="flex gap-3 p-3 hover:bg-black/40 transition-colors">
                    <div className="relative w-20 h-20 rounded overflow-hidden border border-vanguard-border/60 shrink-0 bg-black">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 bg-black/70 px-1 py-0.5 flex items-center justify-between">
                        ...
                        <span className="text-[9px] font-mono text-gray-400">{spot.zone}</span>
                      </div>
                    </div>
          ...
          <div className="xl:col-span-1 flex flex-col bg-vanguard-panel border border-vanguard-border rounded-lg overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar divide-y divide-vanguard-border/60">
              ...
              {!loadingFauna && fauna.length === 0 && (
                <div className="p-4 text-[11px] font-mono text-gray-500">
                  No catalog entries yet. Use NEW ENTRY to seed the local fauna profile for this
                  estate.
                </div>
              )}
              {fauna
                ...
                .map((entry) => (
                  <div
                    key={entry.id}
                    className="p-3 flex flex-col gap-1 hover:bg-black/40 transition-colors"
                  >
                    ...
                    {entry.notes && (
                      <div className="text-[10px] font-mono text-gray-500">{entry.notes}</div>
                    )}
                    {entry.citation && (
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setEditingEntry((prev) =>
                            prev ? { ...prev, estimatedCount: Number(e.target.value) || 0 } : prev
                          )
                        }
                        min={0}
                      />
