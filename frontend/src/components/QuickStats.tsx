...
const QuickStats: React.FC<QuickStatsProps> = ({ estateId }) => {
  ...
  const stats = [
    ...
    },
    {
      ...
      icon: Activity,
      color:
        threatMultiplier && threatMultiplier >= 1.8
          ? 'text-red-400'
          : threatMultiplier && threatMultiplier >= 1.4
            ? 'text-orange-400'
  ...
  return (
    <div className="h-full flex flex-col p-3">
      <h3 className="text-[10px] font-semibold text-gray-500 mb-2 tracking-widest uppercase">
        Quick Stats
      </h3>
