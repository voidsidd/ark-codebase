        ...
        <div className="border border-vanguard-border rounded-lg bg-black/40 overflow-hidden">
          ...
          <div className="flex items-center justify-between px-3 py-2 border-b border-vanguard-border bg-black/40">
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={() => navigate(`/estate/${estateId}/intel`)}
                className="ml-2 text-[9px] font-mono text-green-400 hover:underline cursor-pointer"
              >
                (Edit)
              </button>
            </div>
          ...
          {zoneInventory.length === 0 ? (
            <div className="px-3 py-4 text-center">
              ...
              <div className="text-[10px] font-mono text-white/30">No inventory for this zone.</div>
              <button
                onClick={() => navigate(`/estate/${estateId}/intel`)}
                className="mt-2 px-3 py-1.5 text-[9px] font-mono border border-green-500/40 text-green-400 rounded bg-green-950/20 hover:bg-green-950/40 transition-colors cursor-pointer"
              >
                Go to Estate Intelligence
              </button>
            </div>
          ) : (
            <table className="w-full text-[10px] font-mono">
              ...
              <tfoot>
                <tr className="border-t border-vanguard-border bg-black/60">
                  <td colSpan={3} className="px-3 py-2 text-white/40 font-bold">
                    TOTAL EXPOSURE
                  </td>
      ...
      <div>
        ...
        <div className="border border-vanguard-border rounded-lg bg-black/40 p-3 space-y-3">
          <div className="text-[10px] font-mono text-white/50 leading-relaxed">
            Generate a court-admissible PDF with a cryptographic integrity hash, timeline of events,
            sensor exhibit images, and financial exposure — ready to submit to law enforcement or
            insurance.
          </div>
