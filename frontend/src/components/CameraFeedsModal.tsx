  ...
  const cameras = [
    {
      ...
      zone: zones[0] || 'Z1',
      status: 'ONLINE',
      model: 'TrailGuard AI v2',
      threat: 'NONE',
      image:
        'https://images.unsplash.com/photo-1610419993549-74d1252119eb?q=80&w=800&auto=format&fit=crop',
    },
    {
      id: 'CAM-02',
      zone: zones[1] || 'Z2',
      status: 'ONLINE',
      model: 'TrailGuard AI v1',
      threat: 'DETECTED',
      image:
        'https://images.unsplash.com/photo-1564750965-0ae4bf597cfa?q=80&w=800&auto=format&fit=crop',
    },
    {
      id: 'CAM-03',
      zone: zones[2] || 'Z3',
    ...
    },
    {
      ...
      zone: zones[3] || 'Z4',
      status: 'ONLINE',
      model: 'Standard IP Cam',
      threat: 'NONE',
      image:
        'https://images.unsplash.com/photo-1549479366-cdca7d2d3aee?q=80&w=800&auto=format&fit=crop',
    },
  ];
      ...
      <div className="bg-vanguard-bg border border-vanguard-border rounded-lg shadow-2xl w-full max-w-4xl overflow-hidden flex flex-col max-h-[90vh] animate-in fade-in zoom-in duration-200">
        ...
        <div className="flex justify-between items-center p-4 border-b border-vanguard-border bg-vanguard-panel">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-syne font-bold tracking-widest text-white">
        ...
        <div className="p-4 overflow-y-auto custom-scrollbar flex-1 bg-[#0A0F1A]">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {cameras.map((cam) => (
              <div
                key={cam.id}
                className="bg-vanguard-panel border border-vanguard-border rounded overflow-hidden flex flex-col"
              >
                {/* Camera Header */}
