...
const getStatusColor = (status: string) => {
  switch (status) {
    case 'ACTIVE':
      return 'bg-vanguard-zoneActive text-white shadow-[0_0_10px_rgba(220,38,38,0.5)]';
    case 'MONITORING':
      return 'bg-vanguard-zoneMonitor text-white';
    default:
      return 'bg-vanguard-panel text-gray-400';
  }
};
    ...
    <div className="h-full flex flex-col p-4 bg-vanguard-bg">
      ...
      <div className="mt-3 flex justify-center gap-4 text-[10px] font-mono text-gray-500">
        <div className="flex items-center gap-1.5">
          <div className="w-2 h-2 rounded-full bg-vanguard-zoneClear border border-vanguard-border"></div>{' '}
          CLEAR
        </div>
        <div className="flex items-center gap-1.5">
          <div className="w-2 h-2 rounded-full bg-vanguard-zoneMonitor"></div> MONITORING
        </div>
        <div className="flex items-center gap-1.5">
          <div className="w-2 h-2 rounded-full bg-vanguard-zoneActive shadow-[0_0_5px_rgba(220,38,38,0.5)]"></div>{' '}
          ACTIVE
        </div>
      </div>
    </div>
