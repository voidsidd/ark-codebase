    ...
    if (this.state.error) {
      return (
        <div className="min-h-screen bg-vanguard-bg flex flex-col items-center justify-center gap-4">
          ...
          <div className="font-mono text-[10px] text-white/30 max-w-sm text-center">
            {this.state.error}
          </div>
          <button
            onClick={() => {
        ...
        >
          <div className="flex flex-col min-h-max min-w-[320px]">
            <div className="border-b border-vanguard-border">
              <AlertFeed estateId={id} isEstate={isEstate} />
            </div>
            <div className="border-b border-vanguard-border">
                ...
                <Suspense
                  fallback={
                    <div className="min-h-screen bg-vanguard-bg flex items-center justify-center">
                      <div className="font-mono text-[10px] text-white/30 tracking-widest animate-pulse">
                        LOADING MAP ENGINE...
                      </div>
                    </div>
                  }
