  ...
  return (
    <div className="min-h-screen bg-[#0A0F1A] bg-topo text-white relative selection:bg-vanguard-species selection:text-white pb-24">
      ...
      <div className="relative z-10 px-6 max-w-7xl mx-auto pb-20">
        <h2 className="text-center text-sm font-bold tracking-[0.3em] text-vanguard-species mb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {ESTATES.map((estate) => (
            <div
              ...
              style={{
                borderColor:
                  selectedEstate?.id === estate.id && transitionState === 'pulsing'
                    ? estate.accentColor
                    : undefined,
                boxShadow:
                  selectedEstate?.id === estate.id && transitionState === 'pulsing'
                    ? `0 0 30px ${estate.accentColor}`
                    : undefined,
              }}
            >
              ...
              <div className="relative z-10 flex justify-between items-start">
                <span className="text-sm tracking-widest text-white/80 flex items-center gap-2">
                  <span className="text-lg">{estate.countryFlag}</span>{' '}
                  {estate.country.toUpperCase()}
                </span>
              </div>

              <div className="relative z-10 mt-auto mb-4">
                <h3 className="text-3xl font-bold font-sans tracking-wide mb-1 transition-transform duration-300 group-hover:translate-x-1">
                  {estate.name}
                </h3>
              ...
              <div className="relative z-10 grid grid-cols-3 gap-2 border-t border-white/10 pt-4">
                ...
                <div className="flex flex-col">
                  ...
                  <span
                    className="text-xs font-mono font-semibold text-white/90 truncate"
                    title={estate.primarySpecies}
                  >
