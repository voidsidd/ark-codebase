...
import { Cesium3DTilesTerrainProvider as Cesium3DTilesTerrainProvider_2 } from 'cesium';
...
import { Google2DImageryProvider as Google2DImageryProvider_2 } from 'cesium';
...
orientation?: any;
duration?: number;
complete?: Camera_2.FlightCompleteCallback;
cancel?: Camera_2.FlightCancelledCallback;
...
export declare const Cesium3DTilesTerrainProvider: CesiumComponentType<Cesium3DTilesTerrainProvider_2, Cesium3DTilesTerrainProviderProps>;

declare type Cesium3DTilesTerrainProviderCesiumReadonlyProps = {
...
declare type Cesium3DTilesTerrainProviderOtherProps = {
    children?: ReactNode;
    /** Calls when the terrain provider is successfully created. */
    onReady?: (terrainProvider: Cesium3DTilesTerrainProvider_2) => void;
...
export declare type Cesium3DTilesTerrainProviderProps = Cesium3DTilesTerrainProviderCesiumReadonlyProps & Cesium3DTilesTerrainProviderOtherProps;
...
export declare type CesiumInsideComponentType<E, P = any> = {
    cesiumElement: E;
} & PureComponent<WithContextProps<P, any>>;
...
declare const cesiumProps_19: readonly ["availability", "billboard", "box", "corridor", "cylinder", "description", "ellipse", "ellipsoid", "entityCollection", "label", "model", "name", "orientation", "path", "plane", "parent", "point", "polygon", "polyline", "polylineVolume", "position", "properties", "rectangle", "show", "tileset", "trackingReferenceFrame", "viewFrom", "wall"];

declare const cesiumProps_2: readonly ["blendOption", "coarseDepthTestDistance", "debugShowBoundingVolume", "debugShowTextureAtlas", "modelMatrix", "show", "threePointDepthTestDistance"];

declare const cesiumProps_20: readonly ["density", "enabled", "heightFalloff", "heightScalar", "maxHeight", "minimumBrightness", "renderable", "screenSpaceErrorFactor", "visualDensityScalar"];

declare const cesiumProps_21: readonly ["clustering", "name", "show"];

declare const cesiumProps_22: readonly ["atmosphereBrightnessShift", "atmosphereHueShift", "atmosphereSaturationShift", "backFaceCulling", "baseColor", "clippingPlanes", "depthTestAgainstTerrain", "enableLighting", "lightingFadeInDistance", "lightingFadeOutDistance", "material", "maximumScreenSpaceError", "nightFadeInDistance", "nightFadeOutDistance", "oceanNormalMapUrl", "shadows", "show", "showGroundAtmosphere", "showWaterEffect", "tileCacheSize", "loadingDescendantLimit", "preloadAncestors", "preloadSiblings", "fillHighlightColor", "dynamicAtmosphereLighting", "dynamicAtmosphereLightingFromSun", "showSkirts", "cartographicLimitRectangle", "translucency", "undergroundColor", "undergroundColorAlphaByDistance", "lambertDiffuseMultiplier", "atmosphereLightIntensity", "atmosphereRayleighCoefficient", "atmosphereMieCoefficient", "atmosphereRayleighScaleHeight", "atmosphereMieScaleHeight", "atmosphereMieAnisotropy", "vertexShadowDarkness", "clippingPolygons"];
...
declare const cesiumProps_29: readonly ["blendOption", "coarseDepthTestDistance", "debugShowBoundingVolume", "modelMatrix", "show", "threePointDepthTestDistance"];
...
declare const cesiumProps_31: readonly ["backFaceCulling", "clampAnimations", "clippingPlanes", "clippingPolygons", "color", "colorBlendAmount", "colorBlendMode", "customShader", "debugShowBoundingVolume", "debugWireframe", "distanceDisplayCondition", "enableVerticalExaggeration", "featureIdLabel", "heightReference", "id", "imageBasedLighting", "instanceFeatureIdLabel", "lightColor", "maximumScale", "minimumPixelSize", "modelMatrix", "outlineColor", "scale", "shadows", "show", "showCreditsOnScreen", "showOutline", "silhouetteColor", "silhouetteSize", "splitDirection", "style", "pointCloudShading"];
...
declare const cesiumProps_37: readonly ["color", "pixelSize", "outlineColor", "outlineWidth", "show", "scaleByDistance", "translucencyByDistance", "heightReference", "distanceDisplayCondition", "disableDepthTestDistance", "splitDirection"];

declare const cesiumProps_38: readonly ["color", "disableDepthTestDistance", "distanceDisplayCondition", "id", "outlineColor", "outlineWidth", "pixelSize", "position", "scaleByDistance", "show", "splitDirection", "translucencyByDistance"];
...
declare const cesiumProps_50: readonly ["bounceAnimationTime", "enableCollisionDetection", "enableInputs", "enableLook", "enableRotate", "enableTilt", "enableTranslate", "enableZoom", "inertiaSpin", "inertiaTranslate", "inertiaZoom", "lookEventTypes", "maximumMovementRatio", "maximumZoomDistance", "minimumCollisionTerrainHeight", "minimumPickingTerrainHeight", "minimumTrackBallHeight", "minimumZoomDistance", "rotateEventTypes", "tiltEventTypes", "translateEventTypes", "zoomEventTypes", "minimumPickingTerrainDistanceWithInertia", "maximumTiltAngle", "zoomFactor"];
...
declare const cesiumProps_56: readonly ["terrainShadows", "clockTrackedDataSource", "targetFrameRate", "useDefaultRenderLoop", "resolutionScale", "allowDataSourcesToSuspendAnimation", "trackedEntity", "selectedEntity", "shadows", "useBrowserRecommendedResolution", "creditDisplay"];
...
declare const cesiumProps_8: readonly ["resolutionScale", "useDefaultRenderLoop", "targetFrameRate", "useBrowserRecommendedResolution", "allowDataSourcesToSuspendAnimation", "trackedEntity", "clockTrackedDataSource", "terrainProvider", "creditDisplay"];

declare const cesiumProps_9: readonly ["classificationType", "debugShowBoundingVolume", "debugShowShadowVolume", "show"];

declare type CesiumPureProps<T> = Exclude<StringOnly<keyof T>, FunctionKeys<T> | Exclude<ReadonlyKeys<T>, CesiumEventKeys<T>> | "prototype" | PrivateKeys<T>>;

declare const cesiumReadonlyProps: readonly ["asynchronouslyLoadImagery", "classificationType", "cullWithChildrenBounds", "debugHeatmapTilePropertyName", "ellipsoid", "enableDebugWireframe", "heightReference", "modelUpAxis", "modelForwardAxis", "projectTo2D", "enableShowOutline", "enablePick", "environmentMapOptions", "scene"];
...
declare const cesiumReadonlyProps_11: readonly ["allowPicking", "asynchronous", "basePath", "credit", "enableDebugWireframe", "gltf", "incrementallyLoadTextures", "scene", "releaseGltfJson", "cull", "opaquePass", "upAxis", "forwardAxis", "content", "enableShowOutline", "projectTo2D", "classificationType", "gltfCallback", "enablePick", "environmentMapOptions"];
...
declare const cesiumReadonlyProps_9: readonly ["rectangle", "maximumAnisotropy", "minimumTerrainLevel", "maximumTerrainLevel", "imageryProvider"];
...
export declare const createCesiumComponent: <Element, Props extends object, State = any>({ renderContainer, noChildren, containerProps, defaultProps, ...options }: CesiumComponentOptions<Element, Props, State>) => CesiumComponentType<Element, Props>;
...
export declare const Google2DImageryProvider: CesiumComponentType<Google2DImageryProvider_2, Google2DImageryProviderProps>;

declare type Google2DImageryProviderCesiumReadonlyProps = {
...
declare type Google2DImageryProviderOtherProps = {
    children?: ReactNode;
    /** Calls when the imagery provider is successfully created. */
    onReady?: (imageryProvider: Google2DImageryProvider_2) => void;
...
export declare type Google2DImageryProviderProps = Google2DImageryProviderCesiumReadonlyProps & Google2DImageryProviderOtherProps;
...
export declare type GroundPolylinePrimitiveProps = GroundPolylinePrimitiveCesiumProps & GroundPolylinePrimitiveCesiumReadonlyProps & GroundPolylinePrimitiveOtherProps;
...
export declare type GroundPrimitiveProps = GroundPrimitiveCesiumProps & GroundPrimitiveCesiumReadonlyProps & GroundPrimitiveOtherProps;
...
declare type ImageryLayerCesiumReadonlyProps = Omit<PickCesiumProps<Target_8, typeof cesiumReadonlyProps_9>, "imageryProvider"> & {
...
declare type InvalidProps<T extends string, K extends string, E extends Record<string, string> = {}> = Exclude<T, K | E[keyof E]> | Exclude<K, T | keyof E>;
...
declare type KmlDataSourceOtherProps = EventProps<EventTarget_2> & {
    /** Calls when the Promise for loading data is fullfilled. */
...
declare type LabelCesiumProps = PickCesiumProps<Label_2, typeof cesiumProps_28, "position">;
...
export declare type LensFlareStageProps = PostProcessStageProps & Props_3;

export declare type Merge<A, B> = Omit<A, keyof B> & B;

export declare type MethodOptions<T extends new (...args: any) => any & Record<K, (...args: any[]) => any>, K extends keyof T> = NonNullable<Parameters<InstanceType<T>[K]>[0]>;

export declare type MethodOptions2<T extends new (...args: any) => any & Record<K, (...args: any[]) => any>, K extends keyof T> = NonNullable<Parameters<InstanceType<T>[K]>[1]>;
...
export declare type ModelProps = ModelCesiumProps & ModelCesiumReadonlyProps & ModelOtherProps;
...
export declare type Options<Element, Props extends RootComponentInternalProps, State = any> = {
    name: string;
    create?: (ctx: ResiumContext, props: Props, wrapperRef: HTMLDivElement | null) => Promise<CreateReturnType<Element, State>> | CreateReturnType<Element, State>;
    destroy?: (element: Element, ctx: ResiumContext, wrapperRef: HTMLDivElement | null, state?: State) => void;
    provide?: (element: Element, ctx: ResiumContext, props?: Props, state?: State) => Partial<ResiumContext>;
    update?: (element: Element, props: Props, prevProps: Props, context: ResiumContext) => void | Promise<void>;
...
export declare const PostProcessStage: CesiumComponentType<PostProcessStage_2, PostProcessStageProps>;
...
export declare type PostProcessStageProps = PostProcessStageCesiumProps_2 & PostProcessStageCesiumReadonlyProps;
...
export declare type PrimitiveProps = PrimitiveCesiumProps & PrimitiveCesiumReadonlyProps & PrimtiiveOtherProps;
...
export declare const Provider: Provider_2<ResiumContext>;
...
export declare const ShadowMap: CesiumComponentType<ShadowMap_2, ShadowMapCesiumProps>;
...
export declare type SilhouetteStageProps = PostProcessStageCompositeProps & Props_9;
...
export declare type StaticMethodOptions<T extends Record<K, (...args: any[]) => any>, K extends keyof T> = NonNullable<Parameters<T[K]>[0]>;

export declare type StaticMethodOptions2<T extends Record<K, (...args: any[]) => any>, K extends keyof T> = NonNullable<Parameters<T[K]>[1]>;
...
declare type Target_10 = Merge<Model_2, Parameters<(typeof Model_2)["fromGltfAsync"]>[0]>;
...
declare type Target_22 = ShadowMap_2;
...
declare type TimeDynamicPointCloudCesiumReadonlyProps = PickCesiumProps<Target_24, typeof cesiumReadonlyProps_17>;
...
export declare type TimeDynamicPointCloudProps = TimeDynamicPointCloudCesiumProps & TimeDynamicPointCloudCesiumReadonlyProps & TimeDynamicPointCloudCesiumEvents & TimeDynamicPointCloudOtherProps;

export declare type UnionMerge<A, B> = Omit<A, keyof A & keyof B> & Omit<B, keyof A & keyof B> & {
    [K in keyof A & keyof B]: A[K] | B[K];
};

export declare type UnusedCesiumProps<T, K, E extends Record<string, string> = {}, I extends string = never> = Exclude<InvalidProps<CesiumPureProps<T>, ArrayKeys<keyof K>, E>, I>;

export declare const useCesium: () => ResiumContext;

export declare const useCesiumComponent: <Element, Props extends RootComponentInternalProps, State = any>({ name, create, destroy, provide, update, cesiumReadonlyProps, cesiumEventProps, otherProps, setCesiumPropsAfterCreate, useCommonEvent, useRootEvent, }: Options<Element, Props, State>, props: Props, ref: any) => [Partial<ResiumContext> | undefined, boolean, RefObject<HTMLDivElement | null>];
...
declare type ViewerCesiumReadonlyProps = PickCesiumProps<Target_25, typeof cesiumReadonlyProps_18>;

declare type ViewerOtherProps = RootEventProps & RootComponentInternalProps & {
    /** Applied to outer `div` element */
    className?: string;
    /** Applied to outer `div` element */
    id?: string;
