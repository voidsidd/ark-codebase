...
Use template from `C:/Users/LENOVO/Desktop/Vanguard/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/Users/LENOVO/Desktop/Vanguard/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "C:/Users/LENOVO/Desktop/Vanguard/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
